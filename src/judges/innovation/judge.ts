...
export const judgeInnovation = async (submission: Project, challenge: HackathonChallenges, provider: LLMProvider = 'groq') => {
    ...
    const metaPrompt = dynamicInnovationJudgePrompt(challenge);
    ...
    const prompt = `
        ...
        <user_instructions>
          Please analyze the innovation aspects of this project according to the criteria above. Produce a final innovation score out of 100 combining your full analysis.
        </user_instructions>
