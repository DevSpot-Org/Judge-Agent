    ...
    public: {
        Tables: {
            ...
            projects: {
                Row: {
                    ...
                    name: string;
                    project_code_type: Database['public']['Enums']['project_code_type'] | null;
        ...
        Views: {
            ...
            hackathon_participants_sorted: {
                Row: {
                    application_status: Database['public']['Enums']['hackathon_participant_application_status'] | null;
                    created_at: string | null;
        ...
        Enums: {
            ...
            hackathon_application_method: 'join' | 'stake' | 'apply' | 'apply_additional' | 'apply_stake' | 'apply_additional_stake';
            hackathon_participant_application_status: 'pending' | 'accepted' | 'rejected';
            ...
            join_type: 'join' | 'stake' | 'apply' | 'apply_additional' | 'apply_stake' | 'apply_additional_stake';
